...
export function ContentIcon({ size = 16 }) {
...
export function RegisteredIcon({ size = 15 }) {
...
export function CompanyIcon({ size = 14 }) {
...
export function LicenceIcon({ size = 14 }) {
...
export function ConnectIcon({ size = 14 }) {
...
export function FamilyIcon({ family, size = 16 }) {
  switch (family) {
